        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p><strong>You recognize that I am just a friendly trazzle who cares and I am NOT A LAWYER, I do NOT represent you, and
                            anything you learn here has no guarantee of accuracy or correctness of any kind. That said, if you find a
                            problem, please let me know!</strong></p>
                    <hr/>

                    <p>Please read these Terms of Service (&quot;Terms&quot;, &quot;Terms of Service&quot;) carefully before using the
                        https://www.namechangr.com website (the &quot;Service&quot;) operated by NameChangr (&quot;us&quot;, &quot;we&quot;,
                        or &quot;our&quot;).</p>
                    ...
                    <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms
                        then you may not access the Service. This Terms of Service was created with the <a
                            href="https://termsfeed.com/terms-conditions/generator/">Terms and Conditions Generator from TermsFeed</a>.</p>
                    ...
                    <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by
                        NameChangr.</p>
                    <p>NameChangr has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any
                        third party web sites or services. You further acknowledge and agree that NameChangr shall not be responsible or
                    ...
                    <p>These Terms shall be governed and construed in accordance with the laws of Utah, United States, without regard to its
